...
function MyOrderCard({order: {date, total, products}}) {
    ...
    return (
        <div className="my-order-card-container flex-1 gap-8 flex justify-between items-center border border-black p-2 pl-4 pr-4 rounded-lg w-full h-full min-w-full">
